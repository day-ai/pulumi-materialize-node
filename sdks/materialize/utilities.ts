...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("materialize");
			params.setVersion("0.8.20");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL21hdGVyaWFsaXplaW5jL21hdGVyaWFsaXplIiwidmVyc2lvbiI6IjAuOC4yMCJ9fQ=="), c => c.charCodeAt(0)));
