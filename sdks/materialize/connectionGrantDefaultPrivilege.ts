...
export class ConnectionGrantDefaultPrivilege extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConnectionGrantDefaultPrivilegeState, opts?: pulumi.CustomResourceOptions): ConnectionGrantDefaultPrivilege {
        return new ConnectionGrantDefaultPrivilege(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'materialize:index/connectionGrantDefaultPrivilege:ConnectionGrantDefaultPrivilege';
     ...
     */
    public static isInstance(obj: any): obj is ConnectionGrantDefaultPrivilege {
    ...
    public readonly connectionGrantDefaultPrivilegeId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: ConnectionGrantDefaultPrivilegeArgs | ConnectionGrantDefaultPrivilegeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ConnectionGrantDefaultPrivilegeState | undefined;
            ...
            const args = argsOrState as ConnectionGrantDefaultPrivilegeArgs | undefined;
