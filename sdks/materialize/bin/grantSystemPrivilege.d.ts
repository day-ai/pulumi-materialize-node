...
export declare class GrantSystemPrivilege extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GrantSystemPrivilegeState, opts?: pulumi.CustomResourceOptions): GrantSystemPrivilege;
    /**
     * Returns true if the given object is an instance of GrantSystemPrivilege.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GrantSystemPrivilege;
    readonly grantSystemPrivilegeId: pulumi.Output<string>;
    /**
