...
export declare class TableGrantDefaultPrivilege extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TableGrantDefaultPrivilegeState, opts?: pulumi.CustomResourceOptions): TableGrantDefaultPrivilege;
    /**
     ...
     */
    static isInstance(obj: any): obj is TableGrantDefaultPrivilege;
    /**
