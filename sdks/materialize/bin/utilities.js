...
async function getPackage() {
    if (_packageRef === undefined) {
        ...
        if (_packageRef === undefined) {
            ...
            params.setVersion("0.9.5");
            params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL21hdGVyaWFsaXplaW5jL21hdGVyaWFsaXplIiwidmVyc2lvbiI6IjAuOS41In19"), c => c.charCodeAt(0)));
