...
export declare class SchemaGrant extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SchemaGrantState, opts?: pulumi.CustomResourceOptions): SchemaGrant;
    /**
     * Returns true if the given object is an instance of SchemaGrant.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SchemaGrant;
    /**
    ...
    readonly schemaGrantId: pulumi.Output<string>;
    /**
...
export interface SchemaGrantState {
    ...
    schemaGrantId?: pulumi.Input<string>;
    /**
     * The schema that is being granted on.
     */
